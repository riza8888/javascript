...
function steam(arr) {
    let listGame = [
        {no: 1, title: 'Grand Theft Auto V', key: 'gta5', price: 290000, genre: 'action' },
        {no: 2, title: `Assassin's Creed Odyssey`, key: 'aco', price: 500000, genre: 'rpg' },
        {no: 3, title: 'Counter Strike: Global Offensive', key: 'csgo', price: 120000, genre: 'first-person shooter' },
        {no: 4, title: `Playerunknown's Battlegrounds`, key: 'pubg', price: 210000, genre: 'first-person shooter' },
        {no: 5, title: 'Monster Hunter: World', key: 'mhw', price: 250000, genre: 'action' }
    ]
 }
